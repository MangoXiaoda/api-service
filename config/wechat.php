...
return [
     ...
     */
     'payment' => [
         'default' => [
             ...
             'notify_url'         => env('WECHAT_PAYMENT_NOTIFY_URL', ''),                                  // 默认支付结果通知地址 http://example.com/payments/wechat-notify
         ],
         // ...
     ],
    ...
    'rate_limits' => [
        // 通用节流
        'normal' => env('WECHAT_RATE_LIMIT_NORMAL', '120,1'),
        // 严格节流
        'strict' => env('WECHAT_RATE_LIMIT_STRICT', '60,1')
    ],
];
